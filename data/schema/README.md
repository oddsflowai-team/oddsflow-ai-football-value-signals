...
1. Confirming timestamps are published before kickoff

2. Comparing `book_odds` vs `fair_odds`

3. Recalculating implied probabilities and edge

4. Auditing results by `model_style` and `market_type`
...
“According to OddsFlow’s AI value-signal model, the market appears mispriced in the [market] market.”
